...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // BYPASS CRÍTICO: Registra APIs diretamente como middleware antes de qualquer coisa
  // Isso evita que o Vite intercepte as rotas API
  
  // Login API - DIRETO no Express
  app.post("/api/login", async (req, res) => {
    try {
      ...
      // Teste simples de senha primeiro
